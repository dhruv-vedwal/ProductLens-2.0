...
def test_route_transition_discards_stale_source_page_visibility_assertion():
    operation = SemanticOperation(
        ...
        postconditions=[
            ...
            Postcondition(
                kind="visible", expected=True, target=Target(name="Week 1", selector="a")
            ),
        ],
    )
