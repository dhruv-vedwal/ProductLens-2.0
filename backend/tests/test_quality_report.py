        ...
        [
            {
                ...
                "text": "This dashboard gives the team a clear starting point for the workflow.",
            }
        ],
        [
            {
...
def test_caption_only_delivery_allows_only_an_explicit_secure_transition_gap():
    ...
    report = inspect_synchronization(
        ...
        [
            {
                "event_id": trace.events[0].id,
                "text": "The workspace is now ready for the walkthrough.",
            }
        ],
        [
            {
...
def test_delivery_quality_report_contains_all_required_scores_and_repair_classification():
    report = delivery_report(
        ...
        story={"story_score": 1},
        video={"visual_score": 0, "hard_failures": ["MISSING_OR_EMPTY_RENDER"]},
    )
