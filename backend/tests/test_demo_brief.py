    ...
    context = ProductContext(
        ...
        page_knowledge=[
            PageKnowledge(
                ...
                evidence_refs=["section:Invoice queue"],
                fingerprint="invoices",
            ),
            PageKnowledge(
                url=configuration,
                title="Invoice Configuration",
                purpose="Routing rules",
                visible_sections=["Approval rules"],
                evidence_refs=["section:Approval rules"],
                fingerprint="config",
            ),
        ],
        candidate_demo_flows=[
            CandidateDemoFlow(
                ...
                expected_outcomes=["Invoice status is understandable"],
                risks=["read-only configuration"],
                score=0.9,
            )
        ],
    )
    ...
    context = ProductContext(
        ...
        page_knowledge=[
            PageKnowledge(
                ...
                actionable_controls=["Open reports"],
                evidence_refs=["section:Summary"],
                fingerprint="page-1",
            )
        ],
        feature_knowledge=[
        ...
        relationships=[
            {
                ...
                "relation": "configures",
                "evidence_refs": ["page:https://example.test/settings"],
                "confidence": 0.9,
            }
        ],
    )
