...
def test_presentation_title_is_concise_and_objective_backed():
    assert concise_demo_title("Show how to create a lead and schedule a follow-up booking") == "Create a lead and schedule a follow-up"
...
def test_presentation_title_omits_following_execution_constraint():
    assert concise_demo_title("Demonstrate the study planner. Do not change any data.") == "The study planner"
