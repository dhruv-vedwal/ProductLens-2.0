...
from productlens.contracts.models import DemoPlan, DemoTrace, EditorialStoryboard, PresentationPlan
from productlens.presentation.scenes import build_scene_plan
from productlens.quality.repair import classify_repair
from productlens.services.generation_policy import production_duration_envelope, safe_render_error
