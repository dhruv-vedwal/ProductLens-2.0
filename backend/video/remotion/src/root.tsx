...
export type DemoProps = { title: string; subtitle: string; outroTitle?: string; outroSubtitle?: string; screenVideo: string; sourceWidth: number; sourceHeight: number; screenFrames: number; frameRate?: number; playbackRate?: number; beats: Beat[]; cursorPaths?: CursorPath[]; narration?: string | null; captions?: Caption[]; scenes?: Scene[]; redactions?: Redaction[]; presentationOptions?: { subtitleStyle?: string; subtitlePosition?: string; subtitleFontSize?: string; cursorStyle?: string } };
...
const BrowserMotion: React.FC<{ video: string; sourceWidth: number; sourceHeight: number; frameRate: number; playbackRate: number; beats: Beat[]; cursorPaths: CursorPath[]; captions: Caption[]; scenes: Scene[]; redactions: Redaction[]; presentationOptions?: DemoProps['presentationOptions'] }> = ({ video, sourceWidth, sourceHeight, frameRate, playbackRate, beats, cursorPaths, captions, scenes, redactions, presentationOptions }) => {
